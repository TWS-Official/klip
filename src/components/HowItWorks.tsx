const steps = [
  ...
  },
  {
    ...
    description:
      "Post klipmu ke TikTok, Instagram Reels, atau YouTube Shorts. Kontencom akan melacak performa views secara otomatis melalui link yang kamu submit.",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-400 text-lg max-w-xl mx-auto">
            Tidak perlu pengalaman brand deals atau negosiasi harga - sistem Kontencom
        ...
        <div className="mt-10 flex justify-center">
          <div className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full glass text-sm text-zinc-400">
            ...
            Pembayaran dijamin aman lewat escrow account Kontencom
          </div>
        </div>
      </div>
    </section>
